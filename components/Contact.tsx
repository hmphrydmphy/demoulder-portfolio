export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 section-tint">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <div className="reveal mb-12">
          ...
          <p className="text-muted text-lg leading-relaxed max-w-xl mx-auto">
            Whether you need a project manager, a marketing strategist, or
            someone who can do both — I&apos;m available and ready to help.
          </p>
        </div>

        {/* Contact card */}
        <div className="reveal glass rounded-2xl p-10 mb-8 space-y-6">
          {/* Email */}
          <div>
          ...
          <div>
            ...
            <a
              ...
              className="text-xl md:text-2xl font-semibold text-foreground hover:text-green-400 transition-colors"
            >
              +63 976 260 8875
            </a>
          </div>
        ...
        <div className="reveal flex justify-center gap-4 flex-wrap">
          {socials.map((social) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="glass w-12 h-12 rounded-full flex items-center justify-center text-muted hover:text-foreground transition-colors"
      ...
      {/* Footer */}
      <div className="mt-24 text-center text-muted text-sm border-t border-border pt-8 max-w-6xl mx-auto px-6">
        <p>
          © {new Date().getFullYear()} Demoulder Humphrey Pimentel. Built with purpose.
        </p>
      </div>
    </section>
  );
